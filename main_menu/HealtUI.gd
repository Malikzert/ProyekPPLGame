...
@onready var hearts_container: HBoxContainer = $HealtUI/HeartsContainer

var heart_full = preload("res://assets/Healtpoint/Heart-Full.png")
var heart_empty = preload("res://assets/Healtpoint/Heart-Empty.png")
